namespace RealArtists.Slack {
  ...
  public class SlackBotApi : IDisposable {
    private static readonly string _Version = typeof(SlackBotApi).Assembly.GetName().Version.ToString();
    ...
    public SlackBotApi(string token) {
      ...
      headers.UserAgent.Add(new ProductInfoHeaderValue("RealArtists.Slack", _Version));
    }
